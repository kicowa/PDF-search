...
if __name__ == '__main__':
    if getattr(sys, 'frozen', False):
        # Jeśli aplikacja jest skompilowana (frozen)
        script_path = os.path.abspath(__file__)
        sys.argv = ["streamlit", "run", script_path, "--browser.serverAddress", "localhost", "--server.headless", "true"]
        bootstrap.run(script_path, '', [], flag_options={})
    else:
        # Jeśli aplikacja jest uruchamiana z Pythona
        main() 