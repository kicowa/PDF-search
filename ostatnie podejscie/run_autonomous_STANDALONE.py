...
print(f"[LAUNCHER] Tymczasowy plik aplikacji: {app_path}")
print("[LAUNCHER] Uruchamiam Streamlit...")
...
# Poczekaj chwilę aż serwer wystartuje
time.sleep(4)
print("[LAUNCHER] Otwieram przeglądarkę na http://localhost:8501")
